      ...
      {stage === "reflection" && (
        <section className="question-card reflection-card">
          ...
          <fieldset className="work-style">
            <legend>Как ты в основном выполнял задания?</legend>
            {[
              ["check", "Последовательно проверял варианты и старался понять решение"],
              ["hints", "Сначала пробовал решить самостоятельно, а к подсказкам обращался только в сложных местах"],
              ["selective", "Уверенно выполнял знакомые задания, а сложные чаще пропускал или смотрел разбор"],
              ["mixed", "В разных заданиях действовал по-разному"],
              ["guess", "Часто отвечал наугад или почти не читал условия"],
            ].map(([value, label]) => (

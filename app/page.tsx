      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <div className="test-guide">
            ...
            <ul>
              <li>Сначала небольшая анкета, затем 13 задач и несколько итоговых вопросов.</li>
              <li>На каждом шаге можно вернуться назад, а в заданиях использовать подсказки.</li>
              <li>
                Если хочется пропустить задачу, нажми «Показать полный разбор» — правильный
                ответ подставится автоматически, и можно будет перейти дальше.
              </li>
            </ul>
          </div>

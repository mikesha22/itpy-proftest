      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <div className="test-guide">
            <div className="test-guide-heading">
              <strong>Перед началом</strong>
              <p>Здесь не нужно отвечать идеально — важнее пройти тест спокойно и честно.</p>
            </div>
            <div className="test-guide-grid">
              <div className="test-guide-item">
                <b>Можно вернуться</b>
                <span>Кнопка «Назад» есть на каждом шаге. Ответы анкеты можно изменить.</span>
              </div>
              <div className="test-guide-item">
                <b>Можно взять подсказку</b>
                <span>Она поможет с заданием и немного снизит балл только за него.</span>
              </div>
              <div className="test-guide-item">
                <b>Можно пропустить</b>
                <span>Полный разбор подставит решение, даст 0 баллов и откроет переход дальше.</span>
              </div>
            </div>
          </div>
